...
class GetCharacterTool : public BuiltInTool {
    Project& project_;
public:
    explicit GetCharacterTool(Project& p) : project_(p) {}
...
class ListCharactersTool : public BuiltInTool {
    Project& project_;
public:
    explicit ListCharactersTool(Project& p) : project_(p) {}
...
class CreateCharacterTool : public BuiltInTool {
    Project& project_;
public:
    explicit CreateCharacterTool(Project& p) : project_(p) {}
...
class UpdateCharacterTool : public BuiltInTool {
    Project& project_;
public:
    explicit UpdateCharacterTool(Project& p) : project_(p) {}
