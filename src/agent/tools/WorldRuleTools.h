...
public:
    explicit GetWorldRuleTool(std::shared_ptr<ProjectAccess> p) : project_(p) {}
...
class ListWorldRulesTool : public BuiltInTool {
    std::shared_ptr<ProjectAccess> project_;
public:
    explicit ListWorldRulesTool(std::shared_ptr<ProjectAccess> p) : project_(p) {}
...
class UpdateWorldRuleTool : public BuiltInTool {
    std::shared_ptr<ProjectAccess> project_;
public:
    explicit UpdateWorldRuleTool(std::shared_ptr<ProjectAccess> p) : project_(p) {}
...
class CreateWorldRuleTool : public BuiltInTool {
    std::shared_ptr<ProjectAccess> project_;
public:
    explicit CreateWorldRuleTool(std::shared_ptr<ProjectAccess> p) : project_(p) {}
...
class DeleteWorldRuleTool : public BuiltInTool {
    std::shared_ptr<ProjectAccess> project_;
public:
    explicit DeleteWorldRuleTool(std::shared_ptr<ProjectAccess> p) : project_(p) {}
