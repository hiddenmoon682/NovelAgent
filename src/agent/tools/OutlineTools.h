...
public:
    explicit GetOutlineTool(std::shared_ptr<ProjectAccess> p) : project_(p) {}
...
class GetProjectStatusTool : public BuiltInTool {
    std::shared_ptr<ProjectAccess> project_;
public:
    explicit GetProjectStatusTool(std::shared_ptr<ProjectAccess> p) : project_(p) {}
...
class CreateVolumeTool : public BuiltInTool {
    std::shared_ptr<ProjectAccess> project_;
public:
    explicit CreateVolumeTool(std::shared_ptr<ProjectAccess> p) : project_(p) {}
...
class UpdateVolumeTool : public BuiltInTool {
    std::shared_ptr<ProjectAccess> project_;
public:
    explicit UpdateVolumeTool(std::shared_ptr<ProjectAccess> p) : project_(p) {}
...
class CreatePlotThreadTool : public BuiltInTool {
    std::shared_ptr<ProjectAccess> project_;
public:
    explicit CreatePlotThreadTool(std::shared_ptr<ProjectAccess> p) : project_(p) {}
...
class UpdatePlotThreadTool : public BuiltInTool {
    std::shared_ptr<ProjectAccess> project_;
public:
    explicit UpdatePlotThreadTool(std::shared_ptr<ProjectAccess> p) : project_(p) {}
