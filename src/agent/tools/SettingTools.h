...
public:
    explicit GetSettingTool(std::shared_ptr<ProjectAccess> p) : project_(p) {}
...
class ListSettingsTool : public BuiltInTool {
    std::shared_ptr<ProjectAccess> project_;
public:
    explicit ListSettingsTool(std::shared_ptr<ProjectAccess> p) : project_(p) {}
...
class UpdateSettingTool : public BuiltInTool {
    std::shared_ptr<ProjectAccess> project_;
public:
    explicit UpdateSettingTool(std::shared_ptr<ProjectAccess> p) : project_(p) {}
...
class CreateSettingTool : public BuiltInTool {
    std::shared_ptr<ProjectAccess> project_;
public:
    explicit CreateSettingTool(std::shared_ptr<ProjectAccess> p) : project_(p) {}
...
class DeleteSettingTool : public BuiltInTool {
    std::shared_ptr<ProjectAccess> project_;
public:
    explicit DeleteSettingTool(std::shared_ptr<ProjectAccess> p) : project_(p) {}
